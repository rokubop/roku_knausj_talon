...
(cancel|council|counsel)+$: skip()
# the actual behavior of "cancel cancel" is implemented in plugin/cancel/cancel.py; if you want to use a different phrase you must also change cancel_phrase there.
