...
mod = Module()
mod.tag("pedal_scroll_and_teleport", desc="pedal scrolling up or down and teleport")
ctx = Context()
ctx.matches = "tag: user.pedal_scroll_and_teleport"
...
class Actions:
    def pedal_on_tag_enable():
        actions.user.hud_add_log('warning', '<*Pedal: Scroll and teleport />')
