tag: user.parrot_hiss_pop_mouse
mode: user.parrot
and not mode: sleep
-
# settings():
#     user.use_manual_halt_for_hiss = false

parrot(cluck): user.parrot_hiss_pop_mouse_disable()
...
parrot(ee): user.parrot_hiss_pop_mouse_halt_no_click()
