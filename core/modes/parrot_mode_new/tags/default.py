...
mod.tag("parrot_mode_default", desc="Tag for default parrot mode")
ctx.matches = "tag: user.parrot_mode_default"

# @ctx.action_class("user")
# class ParrotSettings:
#     def parrot_mode_color(): return "white"
#     def parrot_mode_on_enable(): actions.user.parrot_mode_default_enable()
#     def parrot_mode_on_disable(): actions.user.parrot_mode_default_disable()
