...
mouse move right:           user.mouse_move_delta_ease_out(100, 0)
mouse move left:            user.mouse_move_delta_ease_out(-100, 0)
mouse move down:            user.mouse_move_delta_ease_out(0, 100)
mouse move up:              user.mouse_move_delta_ease_out(0, -100)
mouse move right <number>:  user.mouse_move_delta_ease_out(number * 100, 0)
mouse move left <number>:   user.mouse_move_delta_ease_out(number * -100, 0)
mouse move down <number>:   user.mouse_move_delta_ease_out(0, number * 100)
mouse move up <number>:     user.mouse_move_delta_ease_out(0, number * -100)
slide left:                 user.mouse_move_delta_linear(-100, 0)
slide right:                user.mouse_move_delta_linear(100, 0)
slide up:                   user.mouse_move_delta_linear(0, -100)
slide down:                 user.mouse_move_delta_linear(0, 100)
slide left <number>:        user.mouse_move_delta_linear(number * -100, 0)
slide right <number>:       user.mouse_move_delta_linear(number * 100, 0)
slide up <number>:          user.mouse_move_delta_linear(0, number * -100)
slide down <number>:        user.mouse_move_delta_linear(0, number * 100)
...
move left ninety:           user.mouse_move_delta_degrees_ease_out(-90, 0)
