...
move mouse right:           user.mouse_move_delta_ease_out(100, 0)
move mouse left:            user.mouse_move_delta_ease_out(-100, 0)
move mouse down:            user.mouse_move_delta_ease_out(0, 100)
move mouse up:              user.mouse_move_delta_ease_out(0, -100)
move mouse right <number>:  user.mouse_move_delta_ease_out(number * 100, 0)
move mouse left <number>:   user.mouse_move_delta_ease_out(number * -100, 0)
move mouse down <number>:   user.mouse_move_delta_ease_out(0, number * 100)
move mouse up <number>:     user.mouse_move_delta_ease_out(0, number * -100)
